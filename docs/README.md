...
| [Stateless MCP Server](subsystems/mcp-server.md)                 | Official Stateless Model Context Protocol (2026-07-28) server for external agent hosts, featuring modular built-in tool definitions (`shadowclaw_server_*`), client tool name centralization, and dynamic browser tool relaying |
