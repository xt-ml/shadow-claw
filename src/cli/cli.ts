...
import { runWebRtcListenCommand } from "./commands/webrtc-listen.js";
import { runMcpCommand } from "./commands/mcp.js";
import { runSkillsIndexCommand } from "./commands/skills-index.js";
import { resolveCacheDir } from "./utils/resolve-cache-dir.js";
import { runAgentCommand } from "./commands/agent.js";

const toolchainRoot = getProjectRoot(import.meta.url);

const terminationCleanups = new Set<(signal: string) => void>();
export function registerTerminationCleanup(
  fn: (signal: string) => void,
): () => boolean {
...
program
  ...
  .option(
    ...
    (v: string, prev: string[] | undefined) => (prev ? [...prev, v] : [v]),
    [] as string[],
  )
