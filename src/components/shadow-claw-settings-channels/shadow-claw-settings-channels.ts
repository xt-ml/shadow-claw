...
const elementName = "shadow-claw-settings-channels";

export class ShadowClawSettingsChannels extends ShadowClawElement {
  static componentPath = `components/${elementName}`;
  static styles = `${ShadowClawSettingsChannels.componentPath}/${elementName}.css`;
  static template = `${ShadowClawSettingsChannels.componentPath}/${elementName}.html`;
...
customElements.define(elementName, ShadowClawSettingsChannels);
