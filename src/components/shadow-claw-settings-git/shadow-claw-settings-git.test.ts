...
const { ShadowClawSettingsGit } = await import("./shadow-claw-settings-git.js");
const { showSuccess } = await import("../../toast.js");

describe("shadow-claw-settings-git", () => {
  ...
  it("registers custom element", () => {
    expect(customElements.get("shadow-claw-settings-git")).toBe(
      ShadowClawSettingsGit,
    );
  });

  it("renders correctly after connectedCallback", async () => {
    const el = new ShadowClawSettingsGit();
