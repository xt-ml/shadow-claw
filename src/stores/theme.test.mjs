...
describe("themeStore", () => {
  ...
  it("applies and persists explicit theme", async () => {
    const { themeStore } = await import("./theme.mjs");
  ...
  it("applies classes to shadow-claw element", async () => {
    const shadowClawElement = document.createElement("shadow-claw");
    document.body.appendChild(shadowClawElement);
  ...
  it("responds to system theme change when theme is system", async () => {
